...
const HeroSection = () => {
  return (
    <section className="bg-gradient-to-r from-black via-green-900 to-green-800 text-white  ">
      <div className=" mx-auto grid grid-cols-6 lg:grid-cols-12 xl:grid-cols-12 items-center justify-center ">
        <div className="pl-24 relative col-span-6 mb-12">
        <h1 className="xl:text-5xl lg:text-4xl md:text-2xl text-xl font-bold mb-4 relative " style={{lineHeight:'4.7rem'}}>
  OneStop for 
